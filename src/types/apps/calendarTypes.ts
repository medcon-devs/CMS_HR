...
export type CalendarFiltersType = 'Personal Leave' | 'Annual Leave' | 'Sick Leave' | 'Other'

export type EventDateType = Date | null | undefined

export type CalendarColors = {
  'Personal Leave': ThemeColor
  'Annual Leave': ThemeColor
  'Sick Leave': ThemeColor
  Other: ThemeColor
}
